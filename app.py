...
def main():
    ...
    .stApp {
        ...
        background-image: 
            ...
            radial-gradient(circle at 50% 80%, rgba(255, 255, 255, 0.05) 1.5px, transparent 1.5px);
    ...
    /* 標題與分隔線套用霓虹冷光 */
    hr { border-top: 1px solid #45a29e; }
    h1, h2, h3, .stMarkdown {
    ...
    div.stButton > button {
        ...
        color: #66fcf1 !important;
        box-shadow: 0 0 8px rgba(102, 252, 241, 0.3) !important;
    }
    div.stButton > button:hover {
        background-color: rgba(102, 252, 241, 0.1) !important;
        border: 1px solid #ffffff !important;
        color: #ffffff !important;
        box-shadow: 0 0 15px rgba(102, 252, 241, 0.8) !important;
    }
    
    /* 選項與文字輸入框的顏色調整，避免暗色背景下看不見 */
    .stRadio label, .stCheckbox label, .stToggle label, p {
